...
from deepfacev2.commons import weight_utils, folder_utils
from deepfacev2.commons.logger import Logger
from deepfacev2.models.FacialRecognition import FacialRecognition
from deepfacev2.modules.exceptions import InvalidEmbeddingsShapeError
...
class Buffalo_L(FacialRecognition):
    ...
    def load_model(self) -> None:
        ...
        weights_dir = os.path.join(home, ".deepfacev2", "weights")
