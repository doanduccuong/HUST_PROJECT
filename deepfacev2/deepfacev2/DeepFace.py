...
from deepfacev2.commons import package_utils, folder_utils
from deepfacev2.commons.logger import Logger
from deepfacev2.modules import (
    modeling,
    representation,
    verification,
    recognition,
...
from deepfacev2 import __version__
...
def verify_adaptive_patch(
    ...
    using our Adaptive Local Patch Fusion algorithm.
    """
    return verification.verify_adaptive_patch(img1_path=img1_path, img2_path=img2_path)
