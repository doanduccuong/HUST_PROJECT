...
from deepfacev2.commons import folder_utils, package_utils
from deepfacev2.commons.logger import Logger
from deepfacev2.modules.exceptions import UnimplementedError
...
def download_weights_if_necessary(
    ...
    target_file = os.path.normpath(os.path.join(home, ".deepfacev2/weights", file_name))
    ...
    if compress_type == "zip":
        with zipfile.ZipFile(f"{target_file}.zip", "r") as zip_ref:
            zip_ref.extractall(os.path.join(home, ".deepfacev2/weights"))
...
def download_all_models_in_one_shot() -> None:
    ...
    from deepfacev2.models.facial_recognition.VGGFace import WEIGHTS_URL as VGGFACE_WEIGHTS
    from deepfacev2.models.facial_recognition.Facenet import FACENET128_WEIGHTS, FACENET512_WEIGHTS
    from deepfacev2.models.facial_recognition.OpenFace import WEIGHTS_URL as OPENFACE_WEIGHTS
    from deepfacev2.models.facial_recognition.FbDeepFace import WEIGHTS_URL as FBDEEPFACE_WEIGHTS
    from deepfacev2.models.facial_recognition.ArcFace import WEIGHTS_URL as ARCFACE_WEIGHTS
    from deepfacev2.models.facial_recognition.DeepID import WEIGHTS_URL as DEEPID_WEIGHTS
    from deepfacev2.models.facial_recognition.SFace import WEIGHTS_URL as SFACE_WEIGHTS
    from deepfacev2.models.facial_recognition.GhostFaceNet import WEIGHTS_URL as GHOSTFACENET_WEIGHTS
    from deepfacev2.models.facial_recognition.Dlib import WEIGHT_URL as DLIB_FR_WEIGHTS
    from deepfacev2.models.demography.Age import WEIGHTS_URL as AGE_WEIGHTS
    from deepfacev2.models.demography.Gender import WEIGHTS_URL as GENDER_WEIGHTS
    from deepfacev2.models.demography.Race import WEIGHTS_URL as RACE_WEIGHTS
    from deepfacev2.models.demography.Emotion import WEIGHTS_URL as EMOTION_WEIGHTS
    from deepfacev2.models.spoofing.FasNet import (
        FIRST_WEIGHTS_URL as FASNET_1ST_WEIGHTS,
        SECOND_WEIGHTS_URL as FASNET_2ND_WEIGHTS,
    )
    from deepfacev2.models.face_detection.Ssd import (
        MODEL_URL as SSD_MODEL,
        WEIGHTS_URL as SSD_WEIGHTS,
    )
    from deepfacev2.models.face_detection.Yolo import YoloModel
    from deepfacev2.models.face_detection.YuNet import WEIGHTS_URL as YUNET_WEIGHTS
    from deepfacev2.models.face_detection.Dlib import WEIGHTS_URL as DLIB_FD_WEIGHTS
    from deepfacev2.models.face_detection.CenterFace import WEIGHTS_URL as CENTERFACE_WEIGHTS
    ...
    for i in WEIGHTS:
        ...
        logger.info(
            f"Downloading {url} to ~/.deepfacev2/weights/{filename} with {compress_type} compression"
        )
