...
\end{center}
\begin{center}
    \textbf{\fontsize{21pt}{0pt}\selectfont Nhận dạng khuôn mặt và xác định cảm xúc khách hàng \break dưới tác động của phẫu thuật thẩm mỹ tích hợp hệ thống CRM }
\vspace{7pt}
\begin{table}[H]
    \centering
    \begin{tabular}{c c}
