...
async def register(file: UploadFile = File(...), name: str = Form(...), user_image: str = Form(None)):
    ...
    try:
        ...
        result = CustomerService.register_customer(temp_file_path, name_clean, user_image)
